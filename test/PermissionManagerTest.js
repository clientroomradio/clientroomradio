...
describe("PermissionManager", () => {
  ...
  var mockSuccessful;
  var mockUser;
  var capturedSocketOnCallback;
  var capturedLoginCallback;
  ...
  beforeEach(() => {
    ...
    mockSocket = {
      on: (token, callback) => {
        capturedSocketOnCallback = callback;
      },
      sendToUser: () => {},
