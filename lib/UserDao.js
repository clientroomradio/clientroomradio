module.exports = function(dataStore, lastfmClient, socket, config, logger) {
    var that = this;
    ...
    that.getUserConfig = function(user) {
        return {
    ...
    function usersChanged() {
        ...
        Object.keys(users).forEach(function(username) {
            ...
            socket.sendToUser(user, "config", that.getUserConfig(user));
        });
    ...
    socket.on("logout", function (user) {
        ...
        that.removeByUsername(user.username);
    });
