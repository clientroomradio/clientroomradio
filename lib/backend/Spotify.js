...
module.exports = function(winston) {
    ...
    var spSession;
    var spPlayer;
    var spotifyEnabled = fs.existsSync(path.join(__dirname, "../../spotify_appkey.key"));
    ...
    function init() {
        if (spotifyEnabled) {
            spSession = new sp.Session({
                ...
                applicationKey: path.join(__dirname, "../../spotify_appkey.key")
            });
        } else {
            winston.error("No Spotify app key found", path.join(__dirname, "../../spotify_appkey.key"));
        }
