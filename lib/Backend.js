...
module.exports = function(dataStore, currentTrackDao, lastfm, spotify, skippers, socket, chat, logger) {
    var tracks = [];
    var requests = [];
    ...
    function onGotContext(track) {
        ...
        currentTrackDao.setCurrentTrack(track);
    }
    ...
    function onEndTrack() {
        ...
        var currentTrack = currentTrackDao.getCurrentTrack();
        ...
        currentTrackDao.setCurrentTrack({});
